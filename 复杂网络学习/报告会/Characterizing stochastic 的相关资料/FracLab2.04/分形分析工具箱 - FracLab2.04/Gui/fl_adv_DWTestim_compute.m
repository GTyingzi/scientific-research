   ...
   case 'scaleMin'
    ...
    case 'compute_HofT'
        ...
        if rb_time == 1
            ...
            varargout{1}=varname;
            eval(['global ' varname]);
            eval(['[', varname, 'alpha,vect_ech1,vect_log1,handlefig]=DWTestim_all(SigIn,whichT,RegParam,type_ond,size,Reg,Tol,Gamma,FindMax,radius,DeepScale,0);']);
        ...
        elseif rb_time == 0
            ...
            eval([varname '=DWTestim_all(SigIn,[],RegParam,type_ond,size,Reg,Tol,Gamma,FindMax,radius,DeepScale,0,echelle);']);
