...
b = uicontrol('Parent',a, ...
	...
	'String','Multifractal regularization', ...
	'Style','text', ...
	'Tag','StaticText_reg_title1');
b = uicontrol('Parent',a, ...
	'Units','normalized', ...
	'FontUnits','normalized', ...
	...
	'String','1D and 2D signals (L2 norm)', ...
	'Style','text', ...
	'Tag','StaticText_reg_title2');
b = uicontrol('Parent',a, ...
	'Units','normalized', ...
	'FontUnits','normalized', ...
	'FontSize',0.55034469, ...
	...
	'Style','text', ...
	'Tag','StaticText_reg_param');
b = uicontrol('Parent',a, ...
	'Units','normalized', ...
	'FontUnits','normalized', ...
	'BackgroundColor',[1 1 1], ...
	'Callback','fl_reg_compute(''edit_param'');', ...
	'FontSize',0.532, ...
	'Position',[0.8 0.416 0.1 0.08], ...
	'String','1', ...
	'Style','edit', ...
	'Tag','EditText_reg_param');
b = uicontrol('Parent',a, ...
	'Units','normalized', ...
	'FontUnits','normalized', ...
	'Callback','fl_reg_compute(''slider_param'');', ...
	'FontSize',0.55034469, ...
	'Max',5, ...
	'Position',[0.463333 0.416 0.3 0.076], ...
	'Style','slider', ...
	'Tag','Slider_reg_param', ...
	'Value',1);
b = uicontrol('Parent',a, ...
	'Units','normalized', ...
	'FontUnits','normalized', ...
	'Callback','eval([''global '' fl_reg_compute(''compute'',who);]);', ...
	'FontSize',0.399999999999999, ...
	'FontWeight','bold', ...
	'Position',[0.0833333 0.072 0.233333 0.12], ...
	'String','Compute', ...
	'Tag','Pushbutton_reg_compute');
b = uicontrol('Parent',a, ...
	'Units','normalized', ...
	'FontUnits','normalized', ...
	'Callback','fl_reg_compute(''help'');', ...
	'FontSize',0.399999999999999, ...
	'FontWeight','bold', ...
	'Position',[0.38 0.072 0.233333 0.12], ...
	'String','Help', ...
	'Tag','Pushbutton_reg_help');
b = uicontrol('Parent',a, ...
	'Units','normalized', ...
	'FontUnits','normalized', ...
	'Callback','close(findobj(''Tag'',''Fig_gui_fl_reg''));fl_clearerror;', ...
	'FontSize',0.399999999999999, ...
	'FontWeight','bold', ...
...
b = uicontrol('Parent',a, ...
	...
	'Style','text', ...
	'Tag','StaticText_input_reg');
b = uicontrol('Parent',a, ...
	'Units','normalized', ...
	'FontUnits','normalized', ...
	'Callback','fl_reg_compute(''refresh'');', ...
	'FontSize',0.493827160493827, ...
	'FontWeight','bold', ...
	'Position',[0.73 0.62 0.175 0.09], ...
	'String','Refresh', ...
	'Tag','Pushbutton_refresh_reg');
b = uicontrol('Parent',a, ...
	'Units','normalized', ...
	'FontUnits','normalized', ...
	'BackgroundColor',[1 1 1], ...
...
b = uicontrol('Parent',a, ...
	...
	'String','Start level', ...
	'Style','text', ...
	'Tag','StaticText_reg_level');
b = uicontrol('Parent',a, ...
	'Units','normalized', ...
	'FontUnits','normalized', ...
	'BackgroundColor',[1 1 1], ...
	'Callback','fl_reg_compute(''edit_level'');', ...
	'FontSize',0.532, ...
	'Position',[0.3 0.3 0.1 0.08], ...
	'String',num2str(floor(log2(N))-floor((log2(N))/2)+1), ...
	'Style','edit', ...
	'Tag','EditText_reg_level');
...
% 	'String','Wavelet', ...
% 	'Style','text', ...
% 	'Tag','StaticText_reg_wavelet');


b = uicontrol('Parent',a, ...
	'Units','normalized', ...
	'FontUnits','normalized', ...
	'Callback','fl_reg_compute(''ondelette'');', ...
	'FontSize',0.587097, ...
	'Max',3, ...
	'Min',1, ...
