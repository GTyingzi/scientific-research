...
switch(varargin{1});
   ...
   case 'popupmenu_theme'
	...
	case 3 % Violet Gris
		...
		ud.fill_incolor = [1 1 1];
		ud.fontcolor = [0.32157    0.062745     0.32157];
		ud.ChangeLayout = 1;
		ud.layout = 4;
	...
	case 4 % RgeBlcRonds 
		...
		ud.fill_incolor = [1 1 1];
		ud.fontcolor = [0.7098    0.062745     0.12941];
		ud.ChangeLayout = 1;
		ud.layout = 5;
   ...
   case 'apply_changes'
	...
	if isfield(ud,'logo_frac')  & isfield(ud,'bgcolor') & isfield(ud,'layout')
		...
		set(findobj(options_fig,'Tag','Image1'),'CData',logo_frac);
		set(findobj(options_fig,'Tag','Image1'),'AlphaData',alpha_frac);
