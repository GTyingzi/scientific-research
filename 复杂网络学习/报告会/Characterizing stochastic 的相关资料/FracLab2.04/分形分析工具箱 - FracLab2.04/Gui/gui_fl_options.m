...
Themes_List = { 'Current', 'Default' 'Mirror' 'Circle', 'Classic Red' 'Classic Green' 'Classic Blue' 'Classic White', 'Classic Black','Vertical'};
...
b = uicontrol('Parent',a, ...
	...
	'BackgroundColor',fl_getOption('Fill_inColor'),...
	'String',{ 'Honrizontal', 'Vertical 1','Vertical 2','Mirror','Circle'},...
	'Style','popupmenu', ...
