function varargout=fl_fbm_Levinson_compute(varargin)

% Callback functions for FBM GUI - Generation Parameter Window.


Figfbm = gcf;
if ((isempty(Figfbm)) | (~strcmp(get(Figfbm,'Tag'),'Fig_gui_fl_fbm_Levinson')))
  Figfbm = findobj ('Tag','Fig_gui_fl_fbm_Levinson');
end
  ...
  case 'compute'
	...
	current_cursor=fl_waiton;
		...
		if(strcmp(rseed_string,''))
          ...
          chaine=[varname '=fBmlevinson(',num2str(N),...
