function[H,ALPHA,vect_ech1,vect_log1,handlefig]=DWTestim_all(in,time,RegParam,type_ond,siz,Reg,Tol,gamma,FindMax,radius,DeepScale,graph,echelle)
%function[H,ALPHA,vect_ech1,vect_log1,handlefig]=DWTestim_all(in,time,RegParam,type_ond,siz,Reg,Tol,gamma,FindMax,radius,DeepScale,graph,echelle)

%Modified Feb 2006 : Olivier Barrière
%function[ALPHA,vect_ech1,vect_log1,handlefig]=DWTestim_all(in,time,RegParam,type_ond,siz,Reg,Tol,gamma,FindMax,radius,DeepScale,graph,echelle)
